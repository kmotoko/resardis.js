class LoomConfig {
    ...
    constructor ({ chainId, networkName, endpoint }: { chainId: string; networkName: string; endpoint: string }) {
        ...
        this.erc20Registry = require("@resardis-finance/resardis-proxies/networks/ERC20Registry.json")[this.chainId];
        this.moneyMarket = require("@resardis-finance/money-market/networks/MoneyMarket.json")[this.chainId];
    }
}
